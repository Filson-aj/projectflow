        ...
        switch (session?.user?.role) {
            case 'ADMIN':
                return [
                    ...
                    /* { label: 'Project Topics', icon: <BookOpen className="w-5 h-5" />, href: `${baseUrl}/projects`, command: () => router.push('/dashboard/admin/projects') }, */
                    { label: 'Sessions', icon: <Clock className="w-5 h-5" />, href: `${baseUrl}/sessions`, command: () => router.push('/dashboard/admin/sessions') },
                    /* { label: 'Submissions', icon: <FileText className="w-5 h-5" />, href: `${baseUrl}/submissions`, command: () => router.push('/dashboard/admin/submissions') } */
                ];
            case 'COORDINATOR':
                return [
                    ...base,
                    ...
                    { label: 'Project Topics', icon: <BookOpen className="w-5 h-5" />, href: `${baseUrl}/projects`, command: () => router.push('/dashboard/coordinator/projects') },
                    { label: 'Submissions', icon: <FileText className="w-5 h-5" />, href: `${baseUrl}/submissions`, command: () => router.push('/dashboard/coordinator/submissions') }
            ...
            case 'SUPERVISOR':
                return [
                    ...base,
                    { label: 'Students', icon: <Users className="w-5 h-5" />, href: `${baseUrl}/students`, command: () => router.push('/dashboard/supervisor/students') },
                    { label: 'Project Topics', icon: <BookOpen className="w-5 h-5" />, href: `${baseUrl}/projects`, command: () => router.push('/dashboard/supervisor/projects') },
                    { label: 'Submissions', icon: <FileText className="w-5 h-5" />, href: `${baseUrl}/submissions`, command: () => router.push('/dashboard/supervisor/submissions') }
                ];
            case 'STUDENT':
                return [
                    ...base,
                    { label: 'Project Topics', icon: <BookOpen className="w-5 h-5" />, href: `${baseUrl}/projects`, command: () => router.push('/dashboard/student/projects') },
                    { label: 'Submissions', icon: <FileText className="w-5 h-5" />, href: `${baseUrl}/submissions`, command: () => router.push('/dashboard/student/submissions') }
                ];
            default:
                return base;
        }
                        ...
                        <div className='flex item-center justify-between'>
                            ...
                            <div className='flex items-center space-x-6'>
                                ...
                                <div className='relative'>
                                    ...
                                    />
                                    {notifications?.length > 0 && (<Badge value={notifications?.length} severity={`danger`} className='absolute -top-1 -right-1' />)}
                                ...
                                <div className='relative'>
                                    ...
                                    <OverlayPanel ref={profileRef} className='w-80 bg-white/40 backdrop-blur-2xl'>
                                        <div className="p-4">
                                            ...
                                            <Divider className="my-3" />
                                            <Button icon={<LogOut className="w-4 h-4" />} label="Sign Out" className="w-full p-button-danger p-button-outlined" onClick={confirmSignOut} />
                                        </div>
                                    </OverlayPanel>
                                </div>
                            </div>
